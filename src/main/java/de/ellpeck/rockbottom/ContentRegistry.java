...
import de.ellpeck.rockbottom.api.tile.NewBasicTile;
...
public final class ContentRegistry {
    ...
    public static void init() {
        ...
        new ItemBasic(ResourceName.intern("gold_coin")).register();
        new ItemBasic(ResourceName.intern("silver_coin")).register();
        new ItemBasic(ResourceName.intern("copper_coin")).register();
