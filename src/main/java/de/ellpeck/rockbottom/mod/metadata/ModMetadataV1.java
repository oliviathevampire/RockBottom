...
import de.ellpeck.rockbottom.mod.loader.metadata.ContactInformation;
...
import de.ellpeck.rockbottom.mod.util.version.VersionPredicateParser;
...
public class ModMetadataV1 extends AbstractModMetadata implements LoaderModMetadata {
	...
	@Override
	public Collection<de.ellpeck.rockbottom.mod.loader.metadata.Person> getAuthors() {
		return Arrays.asList(authors);
	}

	@Override
	public Collection<de.ellpeck.rockbottom.mod.loader.metadata.Person> getContributors() {
	...
	public static class Person implements de.ellpeck.rockbottom.mod.loader.metadata.Person {
		private String name;
