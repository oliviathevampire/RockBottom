...
import de.ellpeck.rockbottom.render.tile.TileBronzeRenderer;

import java.util.List;

public class BronzeTile extends OreMaterialTile {

    public BronzeTile() {
        super(ResourceName.intern("bronze"));
        this.addProps(StaticTileProps.HAS_CANISTER);
    }

    @Override
    protected ITileRenderer createRenderer(ResourceName name) {
        return new TileBronzeRenderer(name);
    }
