...
public class LogTile extends MetaTile {

    public LogTile() {
        super(ResourceName.intern("log"), false);
        this.addSubTile(ResourceName.intern("log_acacia"));
        this.addSubTile(ResourceName.intern("log_birch"));
        this.addSubTile(ResourceName.intern("log_dark_oak"));
        this.addSubTile(ResourceName.intern("log_jungle"));
        this.addSubTile(ResourceName.intern("log_spruce"));
